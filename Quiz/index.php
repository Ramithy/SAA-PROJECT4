...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Employ ID no (Ex.732116104***)" class="form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="branch" name="branch" placeholder="Select your department" class="form-control input-md" >
   <option value="" <?php
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Infotech<br><br></span>
</div>
