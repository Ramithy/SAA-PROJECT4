...
<div class="row">
<div class="col-lg-6">
<span class="logo">ASSESSMENT PLATFORM</span></div>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Infotech</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">InfoTech</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="infotech" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Infotech</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 1234567890</h4>
		<h4 style="font-family:'typo' ">info@gmail.com</h4>
		<h4 style="font-family:'typo' "> VIT-AP University, VIT-AP University, G-30, Inavolu </h4></div></div>
		</p>
      </div>
