...
<title> Admin || ASSESSMENT PLATFORM </title>
...
if (@$_GET['q'] == 1)
    echo 'class="active"';
?>><a href="dash.php?q=1">Employe's List</a></li>
    <li <?php
if (@$_GET['q'] == 2)
    echo 'class="active"';
...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Add Assessment</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Remove Assessment</a></li>
      </ul>
          </div>
  </div>
</nav>
...
if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
    echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Assessment Details</b></span><br /><br />
